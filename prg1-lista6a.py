...
def media_anual(temperaturas):
    ...
    for temperatura in temperaturas:
        soma += temperatura
    media_anual_temperaturas = soma / len(temperaturas)
    
    meses_com_temperatura_acima_media = []
    for i, temperatura in enumerate(temperaturas):
        if temperatura > media_anual_temperaturas:
            meses_com_temperatura_acima_media.append(i)

    return meses_com_temperatura_acima_media
